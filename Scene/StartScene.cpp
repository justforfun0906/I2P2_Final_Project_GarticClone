...
void StartScene::Initialize() {
    ...
    AddNewObject(new Engine::Label("Gartic Clone", "pirulen.ttf", 120, halfW, halfH / 3 + 50, 10, 255, 255, 255, 0.5, 0.5));

    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", "stage-select/floor.png",halfW - 200, halfH / 2 + 200 , 400, 100);
