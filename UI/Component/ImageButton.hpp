...
namespace Engine {
	...
	protected:
		...
		std::shared_ptr<ALLEGRO_BITMAP> imgHover;
	...
	public:
		...
		explicit ImageButton(std::string img, std::string imgIn, std::string imgHover, float x, float y, float w = 0, float h = 0, float anchorX = 0, float anchorY = 0);
		/// <summary>
